# Old README (pre-CLO-314) — replaced May 2026

> This file preserves the original `README.md` content before the CLO-314
> rewrite. Replaced in May 2026 as part of M9 (Documentation). The new
