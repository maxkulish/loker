The write requires permission approval. Here is the complete design document - once you approve the write, it will land at `docs/designs/CLO-310-loker-resume.md`:
