...
Error: Shell command failed: TASK="clo-316"
BRANCH="feat/clo-316-docs-migration-from-lok"
...
**Note:** Reviewer tooling failed before invoking Gemini; this is a process artifact, not a doc finding.
